...
from torch_ref.ncn_pytorch import RefReversibleTorchNaive
...
ref_reversible_net = RefReversibleTorchNaive(alpha, activation, max_l, n_cache, n_head, Ws)#.cuda()
start_time_ref = time.time()


torch_naive_yi, torch_naive_ya = ref_reversible_net(x, xa)
