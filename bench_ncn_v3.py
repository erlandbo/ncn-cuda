...
#cpp_yi, cpp_ya = fused_ncn_cuda_v1(x, xa, W, alpha, activation, n_cache, n_head, module_l)
cpp_yi, cpp_ya = fused_ncn_cuda_v2(x, xa, W, alpha, activation, n_cache, n_head, module_l)
...
#cpp_x, cpp_xa, cpp_dx, cpp_dxa, cpp_dW = ncn_cuda_module.backward(cpp_yi, cpp_ya, dyi, dya, W, alpha, activation, n_cache, n_head, module_l)
...
print('dW values sanity check:', torch.allclose(torch_naive_dW, cpp_dW, rtol=0, atol=1e-02))
